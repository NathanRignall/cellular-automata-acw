...
\autoref{fig:task1-compare-roll} shows the number of steps taken by the square and diagonal movements for a single simulation with start and end points of (74, 67) and (55, 40).
